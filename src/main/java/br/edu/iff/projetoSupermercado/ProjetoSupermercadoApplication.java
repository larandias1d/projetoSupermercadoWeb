...
import br.edu.iff.projetoSupermercado.repository.PermissaoRepository;
...
public class ProjetoSupermercadoApplication implements CommandLineRunner{
    ...
    public void run(String... args) throws Exception {
        ...
        Permissao pm = new Permissao();
        pm.setNome("ADMIN");
        
        Permissao pm2 = new Permissao();
        pm2.setNome("FUNC");
        
        permissaoRepo.saveAll(List.of(pm, pm2));
        ...
        f.setPermissoes(List.of(pm));
        f.setNome("Maria");
        f.setCpf("684.712.130-01");
        f.setEmail("maria123@hotmail.com");
        f.setCargo("Gerente");
        f.setSalario(2400);
        f.setSenha(new BCryptPasswordEncoder().encode("Maria-123"));
        ...
        f2.setPermissoes(List.of(pm2));
        f2.setNome("José");
        f2.setCpf("684.295.810-57");
        f2.setEmail("jose123@hotmail.com");
        f2.setCargo("Caixa");
        f2.setSalario(1800);
        f2.setSenha(new BCryptPasswordEncoder().encode("Jose-123"));
